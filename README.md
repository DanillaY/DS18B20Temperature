...
<figure>
  <figcaption>Компоненты требуемые для сбора и передачи данных:</figcaption>
	<ul> 
		...
		<li>Wemos Battery Shield - для питания микросхемы через повышающий DC-DC преобразователь на 5 в.</li>
